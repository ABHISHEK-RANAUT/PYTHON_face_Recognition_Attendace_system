    ...
    def fill_attendance():
        ...
        if subb == "":
            ...
            def create_csv():
                ...
                csv_name = (
                    "C:/Users/abhishek/PycharmProjects/Attendace_management_system/Attendance/Manually Attendance/"
                    + DB_table_name
                    + ".csv"
                )
            ...
            def attf():
                ...
                subprocess.Popen(
                    r'explorer /select,"C:\Users\abhishek\PycharmProjects\Attendace_management_system\Attendance\Manually Attendance\-------Check atttendance-------"'
                )
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == "":
                ...
                root.configure(background="grey80")
                cs = (
                    "C:/Users/abhishek/PycharmProjects/Attendace_management_system/"
                    + fileName
                )
    ...
    def Attf():
        ...
        subprocess.Popen(
            r'explorer /select,"C:\Users\abhishek\PycharmProjects\Attendace_management_system\Attendance\-------Check atttendance-------"'
        )
    ...
    def log_in():
        ...
        if username == "abhi":
            if password == "abhi":
                ...
                cs = "C:/Users/abhishek/PycharmProjects/Attendace_management_system/StudentDetails/StudentDetails.csv"
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
